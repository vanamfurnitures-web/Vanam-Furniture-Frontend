...
export default function Header() {
  ...
  useEffect(() => {
    // Check if user.email is equal to "pish@gmail.comm"
    if (user && user.email === "pish@gmail.com" && UserItem.length === 2) {
      ...
      // Update userItem by removing the "admin/dashboard Item" if user.email is not "pish@gmail.comm"
      setUserItem((prevItems) =>
      ...
      <div className="border-b border-[#eee8df] bg-[#f4f0e9]">
        <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-6 lg:px-10">
          ...
          <div className="flex items-center gap-4 text-gray-400">
            <BsInstagram className="cursor-pointer text-sm transition hover:text-amber-800" />
            <AiFillFacebook className="cursor-pointer text-sm transition hover:text-amber-800" />
            <BsTwitter className="cursor-pointer text-sm transition hover:text-amber-800" />
            <AiFillYoutube className="cursor-pointer text-sm transition hover:text-amber-800" />
          </div>
